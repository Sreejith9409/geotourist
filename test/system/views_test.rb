...
class ViewsTest < ApplicationSystemTestCase
  ...
  test "creating a View" do
    ...
    fill_in "Integer", with: @view.integer
    fill_in "Latitude", with: @view.latitude
    fill_in "Longitude", with: @view.longitude
    fill_in "Point", with: @view.point_id
    fill_in "Tour", with: @view.tour_id
