...
class ViewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create view" do
    assert_difference('View.count') do
      post views_url, params: { view: { integer: @view.integer, latitude: @view.latitude, longitude: @view.longitude, point_id: @view.point_id, tour_id: @view.tour_id, user_id: @view.user_id } }
    end
  ...
  test "should update view" do
    patch view_url(@view), params: { view: { integer: @view.integer, latitude: @view.latitude, longitude: @view.longitude, point_id: @view.point_id, tour_id: @view.tour_id, user_id: @view.user_id } }
