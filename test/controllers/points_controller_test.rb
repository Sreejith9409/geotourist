...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference('Point.count') do
      post points_url, params: { point: { description: @point.description, geolocation: @point.geolocation, integer: @point.integer, name: @point.name, string: @point.string, tour_id: @point.tour_id } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { description: @point.description, geolocation: @point.geolocation, integer: @point.integer, name: @point.name, string: @point.string, tour_id: @point.tour_id } }
