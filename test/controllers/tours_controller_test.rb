...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { description: @tour.description, integer: @tour.integer, name: @tour.name, user_id: @tour.user_id } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { description: @tour.description, integer: @tour.integer, name: @tour.name, user_id: @tour.user_id } }
